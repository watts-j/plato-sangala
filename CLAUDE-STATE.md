...
**Retrofit candidate landed on `claude/laughing-darwin-hHYv2`** (2026-05-25). Ports v2.19's KFMon + NickelMenu launcher infrastructure verbatim into sangala-v2.48-base. Needs device test before tagging v2.49. See "Architecture (current)" below and Lessons #37–#41.
...
**`claude/laughing-darwin-hHYv2`** (harness session branch from 2026-05-25, started tip-equal to `sangala-v2.48-base`). Now carries the KFMon retrofit one commit ahead of `sangala-v2.48-base`. When the device test passes, merge this branch into `sangala-v2.48-base` and tag v2.49-sangala from there.
